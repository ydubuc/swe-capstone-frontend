        ...
        <Container fluid class="con">
            ...
            <Row className="body-row body-row-member">
                ...
                <Col className="member-info EzechiName">
                    ...
                    <h5>Team Leader</h5>
                    <p>I obtain my Bachelors Degree in Computer Science in 2017, and I will be completing my Masters in Software Engineering in Spring 2022. I am currently a Sr. Software Engineer at The Home Depot, where our tech stack is Java, Angular and Google Cloud Platform. My hobbies includes playing video games and 3D printing.</p>
                </Col>
            </Row>
            <Row className="body-row body-row-member">
